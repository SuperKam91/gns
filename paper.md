...
A comparison between the performance of the geometric nested sampler and MultiNest is presented in @javid2019nested. Figures 6 - 9 of the paper show their performance on a toroidal model, while Figure 11 shows their relative performance on a complex spherical toy model.
